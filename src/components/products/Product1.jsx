        ...
        <div className="container px-5 py-36 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <img
              ...
              src={image}
              style={{ width: '100%', maxWidth: '400px', height: '300px' }} // Added inline styling for uniformity
            />
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex">
                <span className="title-font font-medium text-2xl text-gray-900"><span>&#8377;</span>{price}</span>
